...
function [x_gb,h_y,i_count] = hgapso(f_target,xmin,xmax,t,dime,p,l,wg,wl,wr,k,pg,pp,f_max,k1,k2)
% start
...
while true
    ...
    % normal iteration
    for i=1:p
        [x,x_lb] = subprocess(i,xmax,xmin,x,x_lb,x_gb,cmax,cmin,dime,wg,wl,wr,f_max,k1,k2);
    end
    [ry,rx] = test_f(x_lb);
    x_gb = argmin(ry,rx);
    % update classifier
